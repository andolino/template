...
<html>
<head>
	<title>PACS Summary Report</title>
</head>
<link 
		rel="stylesheet" 
...
<body>
	...
	<div class="row">
		...
		<div class="col-6 mt-3 pl-0" style="line-height: 1.6">
			...
			<h4 class="mb-0">PAYROLL ACCOUNT CREDIT SYSTEM</h4>
		...
		<div class="col-12 m-3">
			...
			<tr>
				...
				<th rowspan="2">OFFICIAL STATION</th>
			...
			<?php foreach ($pacsData as $row): ?>
				...
				<tr>
					...
					<td><?php echo date('m/Y', strtotime($row->col_period_start)) . ' - ' . date('m/Y', strtotime($row->col_period_end)); ?></td>
