<?php if (!empty($members_id)): ?>
	...
	<div class="cont-loans-list-by-mem row w-100 none">
		<div class="col-9">
   		<div class="row">
   			<div class="col-12">
   		...
   		<table class="table table-sm font-12" id="tbl-loan-list" data-page="" data-id="<?php echo $members_id; ?>">
				<thead>
					<tr>
						<th class="">LOAN REF. No.</th>
						<th class="">DATE OF PROCESSING</th>
						<th class="">MEMBER NAME</th>
						<th class="">LOAN STATUS</th>
						<th class="">LOAN POSTED</th>
						<th>ACTION</th>
					</tr>
				</thead>
				<tbody></tbody>
...
<?php else: ?>
	...
	<div class="cont-loans-list-by-mem row w-100">
		<div class="col-9">
   		<div class="row">
   			<div class="col-12">
 					<a href="javascript:void(0);" class="float-right pr-2 pb-2" 
   		...
   		<table class="table table-sm font-12" id="tbl-loan-list" data-page="">
				<thead>
					<tr>
						<th class="">LOAN REF. No.</th>
						<th class="">DATE OF PROCESSING</th>
