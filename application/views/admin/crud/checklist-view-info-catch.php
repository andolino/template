							...
							<div class="card-body">
								...
								<div class="row p-2">
									...
									<div class="col-xs-12 font-12 p-3" style="border:2px solid #000;">
										<p class="card-text">NOTICED! <br><br> THE TRANSMITTAL SLIP THAT YOUR TRYING TO ACKNOWLEDGE IS NOT INTENDED ON YOUR LOCATION <br><br> PLEASE KINDLY CONTACT PSA CENTRAL OFFICE: <br><br> 82772379 
										</p>
										<!-- <pre>
											<?php //print_r($data); ?>
										</pre>
