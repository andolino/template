...
<div class="tab-content" id="nav-tabContent">
  <div class="tab-pane fade show active pt-3" id="portal-pending" role="tabpanel" aria-labelledby="repair-pending-tab">
    <div class="row">
      <div class="col-sm-12">
        <table class="table font-12 w-100 nowrap condensed" id="tbl-portal-repair-pending" data-status="0">
          <thead>
            <tr>
  ...
  <div class="tab-pane fade pt-3" id="portal-approved" role="tabpanel" aria-labelledby="repair-approved-tab">
    <table class="table font-12 w-100 nowrap condensed" id="tbl-portal-repair-approved" data-status="1">
      <thead>
        <tr>
          <th scope="col">REQUEST #</th>
          <th scope="col">ASSET CATEGORY </th>
  ...
  <div class="tab-pane fade pt-3" id="portal-disapproved" role="tabpanel" aria-labelledby="repair-disapproved-tab">
    <table class="table font-12 w-100 nowrap condensed" id="tbl-portal-repair-disapproved" data-status="2">
      <thead>
        <tr>
          <th scope="col">REQUEST #</th>
          <th scope="col">ASSET CATEGORY </th>
  ...
  <div class="tab-pane fade pt-3" id="portal-cancelled" role="tabpanel" aria-labelledby="repair-cancelled-tab">
    <table class="table font-12 w-100 nowrap condensed" id="tbl-portal-repair-cancelled" data-status="3">
      <thead>
        <tr>
          <th scope="col">REQUEST #</th>
          <th scope="col">ASSET CATEGORY </th>
  ...
  <div class="tab-pane fade pt-3" id="portal-closed" role="tabpanel" aria-labelledby="repair-closed-tab">
    <table class="table font-12 w-100 nowrap condensed" id="tbl-portal-repair-closed" data-status="4">
      <thead>
        <tr>
          <th scope="col">REQUEST #</th>
          <th scope="col">ASSET CATEGORY </th>
