<form id="frm-save-loancomp">
	...
	<div class="cont-process-a-loan row w-100 none">
		<div class="col-12 pr-0">
			...
			<div class="navbar mb-3">
			  <div class="row">
			    <div class="col pr-0">
			      <button type="button" class="btn btn-default btn-lg font-12 rounded-0 border" id="loadPage" data-badge-head="ADD MEMBER" data-link="add-constituent" data-ind="" data-cls="cont-add-member" disabled> Post</button>
			    </div>
      		...
      		<div class="col-sm-4 pr-0">	
			     	<div class="custom-control custom-radio">
						  <input type="radio" id="modeAtm" name="modePymnt" value="atm" class="custom-control-input" checked>
						  <label class="custom-control-label font-12" for="modeAtm">ATM</label>
						</div>
			    </div>
			    <div class="col-sm-5 pl-0">
			      <div class="custom-control custom-radio">
						  <input type="radio" id="modeChk" name="modePymnt" value="check" class="custom-control-input">
				...
				<div class="border">
					...
					<div class="col-12">
					  ...
					  <div class="form-group row">
					    ...
					    <div class="col-sm-7">
					      <input type="text" class="form-control form-control-sm font-12 text-right isNum" id="monthly_salary" value="<?php echo !empty($membersData) ? number_format($membersData->monthly_salary, 2) : ''; ?>" name="monthly_salary" required>
					    </div>
					  </div>
					  <div class="form-group row">
					  ...
					  <div class="form-group row">
					    ...
					    <div class="col-sm-7">
					      <input type="text" class="form-control form-control-sm font-12" id="purpose_of_loan" name="purpose_of_loan">
					    </div>
					  </div>
					  <div class="form-group row">
					    <label for="net_takehome_pay" class="col-sm-5 pr-0 col-form-label col-form-label-sm font-12">Net Take Home Pay:</label>
					    <div class="col-sm-7">
					      <input type="contact_no" class="form-control form-control-sm font-12 isNum text-right" id="net_takehome_pay" name="net_takehome_pay">
					    </div>
					  </div>
					</div>
					...
					<div class="col-12">
					    ...
					    <div class="col-sm-6 pl-0">
					      <input type="text" class="form-control form-control-sm font-12 ref_no_evt" data-mem="<?php echo $members_id; ?>" id="prev_ref_no" name="prev_ref_no">
					    </div>
					  </div>
					  <div class="form-group row">
					...
					<div class="col-12">
					    ...
					    <div class="col-sm-8 pl-0">
					      <input type="text" class="form-control form-control-sm font-12" id="prev_loan_per_pay_start" name="prev_loan_per_pay_start" readonly>
					    </div>
					  </div>
					  <div class="form-group row">
					    <label for="prev_loan_per_pay_end" class="col-sm-4 pr-0 col-form-label col-form-label-sm font-12">Period End:</label>
					    <div class="col-sm-8 pl-0">
					      <input type="text" class="form-control form-control-sm font-12" id="prev_loan_per_pay_end" name="prev_loan_per_pay_end" readonly>
					    </div>
					  </div>
					  <div class="form-group row">
					  ...
					  <div class="form-group row">
					    ...
					    <div class="col-sm-8 pl-0">
					      <input type="text" class="form-control form-control-sm font-12" id="prev_loan_tot_amnt" name="prev_loan_tot_amnt" readonly>
					    </div>
					  </div>
					  <div class="form-group row">
					    <label for="prev_loan_tot_pymnts" class="col-sm-4 pr-0 col-form-label col-form-label-sm font-12">Total Payments:</label>
					    <div class="col-sm-8 pl-0">
					      <input type="text" class="form-control form-control-sm font-12 isNum" id="prev_loan_tot_pymnts" name="prev_loan_tot_pymnts" readonly>
					    </div>
					  </div>
					  <div class="row">
				...
				<div class="border">
					...
					<div class="col-12">
		      		...
		      		<div class="col-sm-2 pr-0">	
					     	<div class="custom-control custom-radio">
								  <input type="radio" id="radioLoanApprove" name="radioApprovalFlag" value="1" class="custom-control-input" checked>
								  <label class="custom-control-label font-12" for="radioLoanApprove">Approved</label>
								</div>
					    </div>
					    <div class="col-sm-4 pl-0">
					      <div class="custom-control custom-radio">
								  <input type="radio" id="radioLoanDisapproved" name="radioApprovalFlag" value="0" class="custom-control-input">
					    ...
					    <div class="col-sm-4 pl-0">
					      <input type="date" class="form-control form-control-sm font-12" id="date_processed" name="date_processed" required>
					    </div>
					  </div>
					  <div class="form-group row">
					    <label for="loancomp_ref_no" class="col-sm-2 pr-0 col-form-label col-form-label-sm font-12">Ref No.:</label>
					    <div class="col-sm-2 pl-0">
					      <input type="text" class="form-control form-control-sm font-12" id="loancomp_ref_no" name="loancomp_ref_no" required>
					    </div>
					    <label for="is_posted" class="col-sm-2 offset-sm-2 pr-0 col-form-label col-form-label-sm font-12">Posted:</label>
					    <div class="col-sm-4 pl-0">
					      <input type="text" class="form-control form-control-sm font-12" id="is_posted" name="is_posted" readonly>
					    </div>
					  </div>
					  <div class="form-group row">
					    <label for="lcomp_remarks" class="col-sm-2 pr-0 col-form-label col-form-label-sm font-12">Remarks:</label>
					    <div class="col-sm-10 pl-0">
					      <input type="text" class="form-control form-control-sm font-12" id="lcomp_remarks" name="lcomp_remarks">
					    </div>
					  </div>
