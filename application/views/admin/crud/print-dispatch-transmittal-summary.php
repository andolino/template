...
<table style="font-size: 12px;width:60%">
  ...
  <tr><td>&nbsp;</td></tr>
  <tr>
    <td><strong><?php echo strtoupper($vPortalRequest->contact_person_disp); ?></strong></td>
  </tr>
  <tr>
    <td>Chief Statistical Specialist – <?php echo strtoupper($vPortalRequest->location_name_disp); ?></td>
  </tr>
  <tr>
    <td><?php echo ucfirst($vPortalRequest->dispatch_addr); ?></td>
  </tr>
</table>
<br>
...
<tr>
  <td style="padding:0px;">
    ...
    ?>
    Attachment of Transmittal Letter to <strong><?php echo strtoupper($acronym) . " - " . strtoupper($vPortalRequest->contact_person_disp); ?></strong>
  </td>
</tr>
</table>
