		...
		<form id="frm-add-member">
			<div class="row">
					...
					<div class="col-3">
						...
						<input type="text" class="form-control form-control-sm" id="id_no" name="id_no" value="<?php echo $membersData->id_no; ?>" placeholder="...">
					</div>
					<div class="col-3 pl-0">
						<label for="last_name" class="font-12">Last Name</label>
						<input type="text" class="form-control form-control-sm" id="last_name" name="last_name" value="<?php echo $membersData->last_name; ?>" placeholder="...">
					</div>
					<div class="col-3 pl-0">
						<label for="first_name" class="font-12">First Name</label>
						<input type="text" class="form-control form-control-sm" id="first_name" name="first_name" value="<?php echo $membersData->first_name; ?>" placeholder="...">
					</div>
					<div class="col-3 pl-0">
						<label for="middle_name" class="font-12">Middle Name</label>
						<input type="text" class="form-control form-control-sm" id="middle_name" name="middle_name" value="<?php echo $membersData->middle_name; ?>" placeholder="...">
					</div>
					<div class="col-3 mt-2">
						<label for="dob" class="font-12">Date of birth</label>
						<input type="date" class="form-control form-control-sm" id="dob" name="dob" value="<?php echo $membersData->dob; ?>" placeholder="...">
					</div>
