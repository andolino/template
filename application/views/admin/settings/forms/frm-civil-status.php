<form id="frm-civil-status-settings">
	<div class="row">
		<div class="col-12">
			<div class="form-group">
		    <label for="status" class="font-12">CIVIL STATUS</label>
		    <input type="text" class="form-control form-control-sm font-12" id="status" name="status" value="<?php echo !empty($data) ? $data->status : ''; ?>" required>
		    ...
		    <input type="hidden" class="" name="original_val" value="<?php echo !empty($data) ? $data->status : ''; ?>">
