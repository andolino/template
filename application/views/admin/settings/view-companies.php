		...
		<div class="col-7">
   		...
   		<div class="row">
				<div class="col-4 pb-3">
					<button type="button" class="btn btn-sm font-12 btn-default rounded-0 border" id="loadSidePage" data-link="get-companies-frm" data-title="ADD COMPANIES" data-id=""><i class="fas fa-user-plus"></i> Add Companies</button>
				</div>
			</div>
			<table class="table table-sm font-12" id="tbl-companies-settings">
				<thead>
					<tr>
						<th>NAME</th>
						<th>IMAGE</th>
