<div class="cont-view-users w-100 row none">
		<div class="col-8">
   		<div class="row">
   			<div class="col-12">
   		...
   		<div class="row">
				<div class="col-4 pb-3">
					<button type="button" class="btn btn-sm font-12 btn-default rounded-0 border" id="loadSidePage" data-link="get-users-frm" data-title="ADD USER" data-id="" ><i class="fas fa-user-plus"></i> Add Users</button>
				</div>
			</div>
			
			<table class="table table-sm font-12" id="tbl-user-settings">
				<thead>
					<tr>
						<th>SCREEN NAME</th>
						<th>USERNAME</th>
