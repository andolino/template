		...
		<div class="col-7">
   		...
   		<div class="row">
				<div class="col-4 pb-3">
					<button type="button" 
                  class="btn btn-sm font-12 btn-default rounded-0 border" 
                  id="loadSidePage" 
                  data-link="get-asset-category-frm" 
                  data-title="ADD ASSET CATEGORY" 
                  data-id=""><i class="fas fa-user-plus"></i> Add Category</button>
				</div>
			</div>
			<table class="table table-sm font-12" id="tbl-asset-category-settings">
				<thead>
					<tr>
						<th>CATEGORY</th>
						<th>NAME</th>
