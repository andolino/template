<div class="cont-view-member-type w-100 row none">
		<div class="col-7">
   		<div class="row">
   			<div class="col-12">
   		...
   		<div class="row">
				<div class="col-4 pb-3">
					<button type="button" class="btn btn-sm font-12 btn-default rounded-0 border" id="loadSidePage" data-link="get-member-type-frm" data-title="ADD MEMBER TYPE" data-id=""><i class="fas fa-user-plus"></i> Add Member Type</button>
				</div>
			</div>
			<table class="table table-sm font-12" id="tbl-member-type-settings">
				<thead>
					<tr>
						<th>MEMBER TYPE</th>
						<th>ACTION</th>
