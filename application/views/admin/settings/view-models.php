<div class="cont-view-models w-100 row none">
		<div class="col-7">
   		<div class="row">
   			<div class="col-12">
   		...
   		<div class="row">
				<div class="col-4 pb-3">
					<button type="button" class="btn btn-sm font-12 btn-default rounded-0 border" id="loadSidePage" data-link="get-models-frm" data-title="ADD MODELS" data-id=""><i class="fas fa-user-plus"></i> Add Models</button>
				</div>
			</div>
			<table class="table table-sm font-12" id="tbl-models-settings">
				<thead>
					<tr>
						<th>NAME</th>
						<th>ACTION</th>
