		...
		<div class="col-7">
   		...
   		<div class="row">
				<div class="col-4 pb-3">
					<button type="button" class="btn btn-sm font-12 btn-default rounded-0 border" id="loadSidePage" data-link="get-approver-frm" data-title="ADD APPROVAL" data-id=""><i class="fas fa-user-plus"></i> Add Approval</button>
				</div>
			</div>
			<table class="table table-sm font-12" id="tbl-approver-settings">
				<thead>
					<tr>
						<th>ID</th>
						<th>LOCATION</th>
