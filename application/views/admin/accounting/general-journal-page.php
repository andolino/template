<div class="cont-general-journal row w-100">
	<div class="col-12">
 		<!-- <div class="row">
 			<div class="col-12">
		...
		<div class="row">
 		...
 		<table class="table table-sm font-12" id="tbl-gj-transaction" data-page="gj-entry">
			<thead>
				<tr>
					<th class=""><input type="checkbox" class="chk-input-to-post" id=""></th>
					<th class="">DATE</th>
