<div class="cont-cash-receipt row w-100">
	<div class="col-12">
 		<!-- <div class="row">
 			<div class="col-12">
		...
		<div class="row">
			<div class="col-4 pb-3">
				<button type="button" class="btn btn-default btn-lg font-12 rounded-0 border" id="loadPage" data-badge-head="ENTRY FOR CRJ" data-link="add-crj-entry" data-ind="" data-cls="cont-crj-entry"><i class="fas fa-plus-circle"	></i> Add Entry</button>
 		...
 		<table class="table table-sm font-12" id="tbl-crj-transaction" data-page="crj-entry">
			<thead>
				<tr>
