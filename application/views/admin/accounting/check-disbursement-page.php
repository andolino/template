<div class="cont-check-disbursement row w-100">
	<div class="col-12">
 		<!-- <div class="row">
 			<div class="col-12">
		...
		<div class="row">
			<div class="col-4 pb-3">
				<button type="button" class="btn btn-default btn-lg font-12 rounded-0 border" id="loadPage" data-badge-head="ENTRY FOR CDJ" data-link="add-cdj-entry" data-ind="" data-cls="cont-cdj-entry"><i class="fas fa-plus-circle"	></i> Add Entry</button>
				<button type="button" class="btn btn-default btn-lg font-12 rounded-0 border" id="postMultiple"><i class="fas fa-copy"></i> Post Selected</button>
			</div>
		</div>
 		<table class="table table-sm font-12" id="tbl-cdj-transaction" data-page="cdj-entry">
			<thead>
				<tr>
					<th><input type="checkbox" class="chk-input-to-post" id=""></th>
					<th class="">DATE</th>
					<th class="">CV NO.</th>
