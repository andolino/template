<div class="cont-cdj-entry row none w-100">
	<div class="col-12">
		<a href="javascript:void(0);" class="float-right pr-2 pb-2" id="loadPage" data-link="tbl-cdj-page" data-badge-head="CHECK DISBURSEMENT"
   								data-cls="cont-check-disbursement" data-placement="top" data-toggle="tooltip" title="Back to List"><i class="fas fa-times"></i></a>
	</div>
		...
		<form id="frm-accounting-entry">
			<div class="row">
					...
					<div class="col-3">
						...
						<!-- 3 means CDJ -->
						<input type="hidden" name="j_type_id" value="3">
					...
					<div class="col-3">
						<label for="cv_no" class="font-12">Check No.</label>
						<input type="text" value="<?php echo !empty($master) ? $master->check_no : ''; ?>" class="form-control form-control-sm font-12 rounded-0" id="check_no" name="check_no" placeholder="...">
					</div>
					<div class="col-3">
