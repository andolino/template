<div class="cont-gj-entry row none w-100">
	<div class="col-12">
		<a href="javascript:void(0);" class="float-right pr-2 pb-2" id="loadPage" data-link="tbl-gj-page" data-badge-head="GENERAL JOURNAL"
   								data-cls="cont-general-journal" data-placement="top" data-toggle="tooltip" title="Back to List"><i class="fas fa-times"></i></a>
	</div>
		...
		<form id="frm-accounting-entry">
			<div class="row">
					...
					<div class="col-3">
						...
						<!-- 3 means CDJ -->
						<input type="hidden" name="j_type_id" value="5">
